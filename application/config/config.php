...
$config['cookie_prefix']    = '';
$config['cookie_domain']    = '.ibcel.com.br'; // Defina o domínio do seu site
$config['cookie_path']      = '/';
$config['cookie_secure']    = TRUE; // Força cookies apenas em conexões seguras
$config['cookie_httponly']  = TRUE; // Impede acesso via JavaScript, aumentando a segurança
/*
|--------------------------------------------------------------------------
