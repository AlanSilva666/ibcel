...
<head>
    <meta charset="UTF-8">
    <?php if (isset($meta_robots_tag) && $meta_robots_tag === true): ?>
        <meta name="robots" content="noindex, nofollow">
    <?php endif; ?>
    <?php
      // Captura a string URI atual
      $current_uri_string = $this->uri->uri_string();
      $canonical_url = base_url(); // Define a URL canônica padrão como a raiz do site

      // Se a URI atual for 'home/index' ou 'home', a canônica deve ser a raiz do site.
      // Isso cobre os casos de https://ibcel.com.br/home/index e https://ibcel.com.br/home
      if ($current_uri_string === 'home/index' || $current_uri_string === 'home') {
          $canonical_url = base_url(); // Aponta para https://ibcel.com.br/
      } else {
          // Para todas as outras páginas, a canônica é a própria URL atual (limpa de index.php se configurado no .htaccess)
          $canonical_url = current_url();
      }

      // Impede que a tag canonical seja adicionada em páginas que já têm noindex.
      // O noindex tem precedência e adicionar canonical seria redundante ou confuso para o robô.
      if (!isset($meta_robots_tag) || $meta_robots_tag !== true) {
          echo '<link rel="canonical" href="' . html_escape($canonical_url) . '">';
      }
    ?>
    ...
    <div class="footer-container">
        ...
        <div class="footer-section">
            ...
            <div class="social-icons">
                <a href="https://www.instagram.com/ibcel_industria/" target="_blank" title="INSTAGRAM"><i class="fa-brands fa-instagram"></i></a>
            </div>
            </div>
    </div>
