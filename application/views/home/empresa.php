...
<style>
    /* Your existing and revised CSS here */
    body {
        margin: 0;
        padding: 0;
    ...
    .main-content-wrapper {
        max-width: 960px; /* Adjust this width to match your content's maximum width */
        margin: 0 auto; /* This centers the wrapper */
        position: relative; /* Crucial for absolute positioning of children */
        padding-top: 10px; /* Add some padding if needed at the top */
    }

    .menu-lateral {
        position: fixed;
        top: 100px;
        left: calc(50% - 480px - 120px); /* 50% da tela - metade da largura do conteúdo - distância lateral */
        z-index: 999;
        display: flex;
    ...
    .banner-clean {
        ...
        line-height: 1.6;
        /* If it's already inside .main-content-wrapper, you might not need max-width/margin-auto here */
        /* max-width: 900px; */ /* Keep this if you want the content inside the banner to be narrower than the wrapper */
        /* margin: 0 auto; */
    }
